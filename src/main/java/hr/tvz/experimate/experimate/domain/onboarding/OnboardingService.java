...
public class OnboardingService {
     ...
     * @param userId the ID of the user
     * @throws QuizResultNotFoundException if no quiz result exists for the user
     * @throws hr.tvz.experimate.experimate.domain.onboarding.exception.QuizCannotBeCancelledException
     ...
     * @throws hr.tvz.experimate.experimate.domain.onboarding.exception.QuizAlreadyCompletedException
