...
function openListingDetail(listing, opts) {
  ...
  if (reminder) {
    ...
    } else if (typeof Auth !== 'undefined' && Auth.getToken() && new Date(listing.meetingDate).toDateString() === new Date().toDateString()) {
      joinBtn = `<button class="btn" style="opacity:0.45;cursor:default;" disabled>Starts today</button>`;
